...
Template = (data, context) => {
  ...
  return (
    <Klutch.KView style={styles.container}>
      <Klutch.KHeader showBackArrow onBackArrowPressed={context.closeMiniApp}>BURNER CARD</Klutch.KHeader>
      ...
      <Klutch.KScrollView style={{ paddingLeft: 10, paddingRight: 10 }}>
        ...
        <Klutch.KPressable
          ...
          <Klutch.KText style={{ marginLeft: 16 }}>Create new burner card</Klutch.KText>
        </Klutch.KPressable>
      </Klutch.KScrollView>
